...
exports.sendVerificationCode = (email, name, code) => {
   ...
   const htmlBody = `<div style="max-width:700px;margin-bottom:1rem;display:flex;align-items:center;gap:10px;font-family:Roboto;font-weight:600;color:#3b5990"><img style="width:30px" src="https://i.ibb.co/D86rBdF/logo.png" alt="facebook"><span>Action required: Reset your Facebook password.</span></div><div style="padding:1rem 0;border-top:1px solid #e5e5e5;border-bottom:1px solid #e5e5e5;color:#141023;font-size:17px;font-family:Roboto"><span>Hello ${name}</span><div style="padding:20px 0"><span style="padding:1.5rem 0">You have attemted to reset your Facebook password. Enter this code and change your password.</span></div><a style="width:200px;padding:10px 15px;background:#4c649b;text-decoration:none;color:#fff;font-weight:600">${code}</a><br><div style="padding-top:20px"><span style="margin:1.5rem 0;color:#898f9c">Facebook allows you to stay in touch with all of your friends, once registered on facebook, you can share photos, organize events and much more.</span></div></div>`;
   return setRequiredCredentialsAndSendEmail(email, subject, htmlBody);
};
